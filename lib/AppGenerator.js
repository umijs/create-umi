...
module.exports = class AppGenerator extends Generator {
  constructor(args, opts) {
    ...
    this.isTypeScript = opts.isTypeScript;
  ...
  writing() {
    ...
    this.fs.copyTpl(this.templatePath(tempPath, 'src', 'pages'), this.destinationPath('src/pages'), context);
    ...
    this.fs.copy(this.templatePath(tempPath, 'README.md'), this.destinationPath('README.md'));
    ...
    if (this.props.react.includes('dva')) {
      if (this.isTypeScript) this.fs.copy(this.templatePath(tempPath, 'dva.d.ts'), this.destinationPath('dva.d.ts'));
