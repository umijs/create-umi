...
module.exports = class BasicGenerator extends Generator {
  ...
  writing() {
    ...
    this.fs.copy(this.templatePath('app', 'package.json'), this.destinationPath('package.json'));
    ...
    if (this.props.react.includes('dva')) {
      ...
      this.fs.copy(this.templatePath('app', 'src', 'dva.js'), this.destinationPath('src/dva.js'));
    }
  }
};
